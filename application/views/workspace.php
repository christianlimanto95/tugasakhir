<div class="header">
    ...
    <div class="header-item disabled" data-header-item-name="redo">
        ...
        <div class="header-item-name">Redo</div>
    </div>
    <div class="header-item" data-header-item-name="zoom-in">
        <div class="header-item-image">
        <svg fill="#000000" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="header-item-name">Zoom In</div>
    </div>
    <div class="header-item" data-header-item-name="zoom-out">
        <div class="header-item-image">
        <svg fill="#000000" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0h24v24H0V0z" fill="none"/>
        ...
        <div class="header-item-name">Zoom Out</div>
    </div>
    <div class="header-item" data-header-item-name="cut">
        <div class="header-item-image">
        ...
        <div class="header-item-name">Cut</div>
    </div>
    <div class="header-item" data-header-item-name="copy">
        <div class="header-item-image">
        <svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0h24v24H0z" fill="none"/>
        ...
        <div class="header-item-name">Copy</div>
    </div>
    <div class="header-item disabled" data-header-item-name="delete">
        <div class="header-item-image">
...
<div class="left-pane">
    ...
    <div class="component-group">
        ...
        <div class="component-item-container">
            ...
            <div class="component-item" data-id="17">
                <div class="component-item-image" style="background-image: url(<?php echo base_url("assets/images/icon.png") ?>);" ></div>
                <div class="component-item-name">Icon</div>
            </div>
            <div class="component-item" data-id="18">
                <div class="component-item-image" style="background-image: url(<?php echo base_url("assets/images/singlelinetext.png") ?>);" ></div>
                <div class="component-item-name">Single Line Text</div>
            </div>
            <div class="component-item" data-id="19">
            ...
            <div class="component-item" data-id="24">
                <div class="component-item-image" style="background-image: url(<?php echo base_url("assets/images/rectangle.png") ?>);" ></div>
                <div class="component-item-name">Rectangle</div>
            </div>
        </div>
    </div>
</div>
...
var componentImage6 = "<?php echo base_url("assets/images/checkboxgroup.png"); ?>";
...
var componentImage24 = "<?php echo base_url("assets/images/rectangle.png"); ?>";
</script>